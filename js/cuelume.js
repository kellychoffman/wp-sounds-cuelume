/**
 * Cuelume 0.1.2 (MIT, Daniel Belyi), inlined because the npm package is
 * ESM-only. Synthesizes every cue live with Web Audio; no audio files.
 * Exposes window.CuelumeSounds = { play, setEnabled, sounds }.
...
( function () {
	...
	window.CuelumeSounds = { play, setEnabled, sounds: Object.keys( RECIPES ) };
} )();
